...
$pagina1   = array(
			array("Swords","Tipo 0", "Swords", 0, 200),
			array("Axes","Tipo 1", "Axes", 512, 200),
			array("Scepters","Tipo 2", "Scepters", 1024, 200),
			array("Spears","Tipo 3", "Spears", 1536, 200),
			array("Bows","Tipo 4", "Bows y Crossbows", 2048, 200),
			array("Staffs","Tipo 5", "Staffs", 2560, 200),
			array("Shields","Tipo 6", "Shields", 3072, 200),
			array("Helm","Tipo 7", "Helm", 3584, 200),
			array("Armor","Tipo 8", "Armor", 4096, 200),
			array("Pants","Tipo 9", "Pants", 4608, 200),
			array("Gloves","Tipo 10", "Gloves", 5120, 200),
			array("Boots","Tipo 11", "Boots", 5632, 200),
			array("Wings","Tipo 12", "Wings, Orbs, Joyas y Mis.", 6144, 200),
			array("Pets","Tipo 13", "Pets, Rings, Pendants y Mis.", 6656, 200),
			array("Pots","Tipo 14", "Pots, Event, Mis.", 7168, 200),
			array("Scrolls","Tipo 15", "Scrolls", 7680, 200)
		);
$pagina1a  = array(
...
switch ($archivo) {
	...
	case "gate":
		...
		$col  = array(
			array( "Flag"  , 1, 0, 1, 45, 2, 1, 0, 0.2, $col_flag),
			array( "Mapa"  , 1, 1, 1, 50, 2, 1, 0, 0.255, $col_0a255),
			array( "X1"    , 1, 2, 1, 35, 2, 1, 0, 0.255, $col_0a255),
			array( "Y1"    , 1, 3, 1, 35, 2, 1, 0, 0.255, $col_0a255),
			array( "X2"    , 1, 4, 1, 35, 2, 1, 0, 0.255, $col_0a255),
			array( "Y2"    , 1, 5, 1, 35, 2, 1, 0, 0.255, $col_0a255),
			array( "Target", 1, 6, 2, 55, 2, 1, 0, 0.511, $col_desgate),
			array( "Dir"   , 1, 8, 1, 35, 2, 1, 0, 0.7, $col_dir),
			array( "Nivel" , 1, 10, 2, 45, 2, 1, 0, 0.4, $col_lvlgate)
		);
	break;
	case "gate2":
		...
		$col  = array(
			...
			array( "X2"    , 1, 4, 1, 35, 2, 1, 0, 0.255, $col_0a255),
			array( "Y2"    , 1, 5, 1, 35, 2, 1, 0, 0.255, $col_0a255),
			array( "Target", 1, 6, 1, 55, 2, 1, 0, 0.511, $col_desgate),
			array( "Dir"   , 1, 7, 1, 35, 2, 1, 0, 0.7, $col_dir),
			array( "Nivel" , 1, 8, 1, 45, 2, 1, 0, 0.255, $col_lvlgate)
		);
	break;
	case "gate3":
		...
		$col  = array(
			...
			array( "Target", 1, 6, 2, 55, 2, 1, 0, 0.511, $col_desgate),
			array( "Dir"   , 1, 8, 1, 35, 2, 1, 0, 0.7, $col_dir),
			array( "Nivel" , 1, 10, 2, 45, 2, 1, 0, 0.65535, $col_lvlgate),
			array( "Nuevo" , 1, 12, 2, 45, 2, 1, 0, 0.65535, $col_0a655)
		);
	break;
	case "gate4":
		...
		$col  = array(
			...
			array( "Target", 1, 6, 2, 55, 2, 1, 0, 0.511, $col_desgate),
			array( "Dir"   , 1, 8, 1, 35, 2, 1, 0, 0.7, $col_dir),
			array( "Nivel" , 1, 9, 1, 45, 2, 1, 0, 0.255, $col_lvlgate)
		);
	break;
	case "item":
		$paginar =  1;
		...
		$col  = array(
			...
			array( "C2"    , 1, 30,  2,  20, 2, 1, 0, -1.65535, ""),
			array( "C3"    , 1, 32,  2,  28, 2, 1, 0, -1.65535, ""),
			array( "C4"    , 1, 34,  1,  20, 2, 1, 1, -1.254, ""),
			...
			array( "38", 1, 76, 1, 20, 2, 1, 0, 0.255, ""),
			array( "39", 1, 77, 1, 20, 2, 1, 0, 0.255, ""),
			array( "40", 1, 78, 1, 20, 2, 1, 0, 0.255, ""),
			array( "41", 1, 79, 1, 20, 2, 1, 0, 0.255, ""),
			array( "42", 1, 80, 1, 20, 2, 1, 0, 0.255, ""),
			array( "43", 1, 81, 1, 20, 2, 1, 0, 0.255, ""),
	...
	case "item2":
		...
		$col  = array(
			array( "Nombre" , 0, 0, 30, 140, 2, 0, 1, 32, $col_t32),
			array( "C2"     , 1, 30, 1, 20, 2, 1, 0, 0.255, ""),
	...
	case "ItemAddOption":
		...
		$col  = array(
			array( "C1", 1, 8, 2, 30, 2, 1, 0, 0.65535, $col_0a655),
			array( "C2", 1, 0, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C3", 1, 2, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C4", 1, 4, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C5", 1, 6, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C6", 1, 12, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C8", 1, 10, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C7", 1, 14, 2, 40, 2, 1, 0, 0.65535, $col_0a655)
		);
	break;
	case "itemsetoption":
		$conf = array(-1, 109, 2, 0, "itemsetoption.bmd","itemsetoption.bmd");
		$col  = array(
			array( "C1", 0, 0, 64, 200, 2, 0, 1, 64, $col_t64),
			...
			array( "C14", 1, 76, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C15", 1, 77, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C16", 1, 78, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C17", 1, 79, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C18", 1, 80, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C19", 1, 81, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C20", 1, 82, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C21", 1, 83, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C22", 1, 84, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C23", 1, 85, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C24", 1, 86, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C25", 1, 87, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C26", 1, 88, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C27", 1, 89, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C28", 1, 90, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C29", 1, 91, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C30", 1, 92, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C31", 1, 93, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C32", 1, 94, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C33", 1, 95, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C34", 1, 96, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C35", 1, 97, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C36", 1, 98, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C37", 1, 99, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C38", 1, 100, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C39", 1, 101, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C40", 1, 102, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C41", 1, 103, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C42", 1, 104, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C43", 1, 105, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C44", 1, 106, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C45", 1, 107, 1, 30, 2, 1, 1, -1.254, $col_1a254),
			array( "C46", 1, 108, 1, 30, 2, 1, 1, -1.254, $col_1a254)
		);
	break;
	case "itemsetoption2":
	...
	case "itemsettype":
		...
		$col  = array(
			array( "C1", 1, 0, 1, 30, 2, 1, 0, 0.255, $col_0a255),
			array( "C2", 1, 1, 1, 30, 2, 1, 0, 0.255, $col_0a255),
			array( "C3", 1, 2, 1, 30, 2, 1, 0, 0.255, $col_0a255),
			array( "C4", 1, 3, 1, 30, 2, 1, 0, 0.255, $col_0a255)
		);
	break;
	case "itemsettype2":
		$paginar =  1;
		...
		$conf = array(-1, 4, 2, 0, "itemsettype.bmd","itemsettype.bmd");
		$col  = array(
			array( "C1", 1, 0, 1, 30, 2, 1, 1, -1.254, $col_0a255),
			array( "C2", 1, 1, 1, 30, 2, 1, 1, -1.254, $col_0a255),
			array( "C3", 1, 2, 1, 30, 2, 1, 1, -1.254, $col_0a255),
			array( "C4", 1, 3, 1, 30, 2, 1, 1, -1.254, $col_0a255)
		);
	break;
	case "JewelOfHarmonyOption":
		$conf = array(-1, 180, 0, 0, "JewelOfHarmonyOption.bmd","JewelOfHarmonyOption.bmd");
		$col  = array(
			array( "C1", 1, 0, 4, 20, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C2", 0, 4, 64, 170, 2, 0, 1, 64, $col_t64),
			array( "C3", 1, 68, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C4", 1, 72, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C5", 1, 76, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C6", 1, 80, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C7", 1, 84, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C8", 1, 88, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C9", 1, 92, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C10", 1, 96, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C11", 1, 100, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C12", 1, 104, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C13", 1, 108, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C14", 1, 112, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C15", 1, 116, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C16", 1, 120, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C17", 1, 124, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C18", 1, 128, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C19", 1, 132, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C20", 1, 136, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C21", 1, 140, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C22", 1, 144, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C23", 1, 148, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C24", 1, 152, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C25", 1, 156, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C26", 1, 160, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C27", 1, 164, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C28", 1, 168, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C29", 1, 172, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C30", 1, 176, 4, 50, 2, 1, 1, -1.2147483647, $col_1a2m)
		);
	break;
	...
	case "Minimap":
		$buscar = 1;
		$conf = array(3, 48, 0, 0, "Minimap.bmd","Minimap.bmd");
		$col  = array(
			array( "X", 1, 4, 4, 30, 2, 1, 0, 0.65535, ""),
			array( "Y", 1, 8, 4, 30, 2, 1, 0, 0.255, ""),
			array( "Rotation Angle", 1, 12, 4, 100, 2, 1, 0, 0.255, ""),
	...
	case "MonsterSkill":
		...
		$col  = array(
			...
			array( "C3", 1, 12, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C4", 1, 16, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C5", 1, 20, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C6", 1, 24, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C7", 1, 28, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C8", 1, 32, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C9", 1, 36, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C10", 1, 40, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C11", 1, 44, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m)
		);
	break;
	case "MonsterSkill2":
	...
	case "movereq":
		...
		$col  = array(
			array(             "Index", 1,  4,  4,  30, 2, 1, 0, 0.255, $col_0a255),
			array(  "Nombre en Server", 0,  8, 32, 160, 2, 0, 1, 32, $col_t32),
			array( "Nombre en Cliente", 0, 40, 32, 160, 2, 0, 1, 32, $col_t32),
			array(               "Zen", 1, 76,  4,  60, 2, 1, 0, 0.16777215, $col_0a167),
			array(           "Lvl Req", 1, 72,  4,  30, 2, 1, 0, 0.65535, $col_0a655),
			array(              "Gate", 1, 80,  4,  30, 2, 1, 0, 0.16777215, $col_0a167)
		);
	break;
	case "movereq2":
	...
	case "pet":
		...
		$col  = array(
			...
			array( "C12", 1, 231, 4, 60, 2, 1, 0, 0.16777215, ""),
	...
	break;
	case "Quest":
		$conf = array(3, 712, 2, 0, "quest.bmd","quest.bmd");
		$col  = array(
			array( "C1", 1, 0, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C2", 1, 2, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
	...
	case "Quest2":
		$paginar = 1;
		$paginas = $pagina2;
		$conf = array(-1, 22, 0, 2, "quest.bmd","quest.bmd",1,712,352,38);
		$col  = array(
	...
	break;
	case "questa":
		$conf = array(3, 584, 1, 0, "quest.bmd","quest.bmd");
		$col  = array(
			array( "C1", 1, 0, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C2", 1, 2, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
			array( "C3", 1, 4, 1, 40, 2, 1, 0, 0.65535, $col_0a655),
...
//			array( "C7", 1, 2, 2, 40, 2, 1, 0, 0.65535, $col_0a655),
	...
	case "skill":
		...
		$col  = array(
			...
			array( "Property2"	  , 1, 55, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "Type"		  , 1, 56, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "Brand"		  , 1, 57, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "KillCount"	  , 1, 58, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "Req.Status[0]", 1, 59, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "Req.Status[1]", 1, 60, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "Req.Status[2]", 1, 61, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "DW/SM"		, 1, 62, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "DK/BK"		, 1, 63, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "Elf/ME"		, 1, 64, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "MG"			, 1, 65, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "DL"			, 1, 66, 1, 28, 2, 1, 0, 0.255, $col_0a255, 1),
			array( "C23"		, 1, 67, 1, 28, 2, 1, 0, 0.255, $col_0a255, 0),
			array( "C24"		, 1, 68, 1, 28, 2, 1, 0, 0.255, $col_0a255, 0),
			array( "C25"		, 1, 69, 1, 28, 2, 1, 0, 0.255, $col_0a255, 0),
			array( "C26"		, 1, 70, 1, 28, 2, 1, 0, 0.255, $col_0a255, 0)
		);
	break;
	case "skill2":
	...
	case "slide":
		$buscar = 1;
		$conf = array(0, 256, 0, 0, "slide.bmd","slide.bmd");
		$col  = array(
	...
	case "socketitem":
		...
		$col  = array(
			...
			array( "C2", 1, 4, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C3", 0, 8, 64, 200, 2, 0, 1, 64, $col_t64),
			array( "C4", 1, 72, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C5", 1, 76, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C6", 1, 80, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
			array( "C7", 1, 84, 4, 30, 2, 1, 1, -1.2147483647, $col_1a2m),
